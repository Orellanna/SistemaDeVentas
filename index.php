            ...
            <div id="recoverform">
              <div class="logo">
                ...
                <form class="form form-material new-lg-form" name="formrecover" id="formrecover" action="">
                 ...
                 <div class="form-group text-center m-t-20">
                  <div class="col-xs-12">
                    <button class="btn btn-outline-danger btn-lg btn-block waves-effect waves-light" name="btn-recuperar" id="btn-recuperar" type="submit"><span class="fa fa-check-square-o"></span> Recuperar Password</button>
                  </div>
                </div>
              </form>
            </div>
