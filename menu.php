                        ...
                        <b class="logo-icon">
                            ...
                            <?php if ($_SESSION['acceso'] == "administradorG") {
                                ...
                                if (file_exists("fotos/logo_principal.png")) {
                                    echo "<img src='fotos/logo_principal.png?v=" . time() . "' width='180' height='60' alt='Logo Principal' class='dark-logo'>"; 
                                } else {
                                ...
                                if (file_exists("fotos/sucursales/" . $_SESSION['cuitsucursal'] . ".png")) {
                                    echo "<img src='fotos/sucursales/" . $_SESSION['cuitsucursal'] . ".png?v=" . time() . "' width='120' height='60' alt='Logo Principal' class='dark-logo'>"; 
                                } else {
                                    echo "<img src='fotos/logo_principal.png?v=" . time() . "' width='180' height='60' alt='Logo Principal' class='dark-logo'>"; 
                                }
                                }
                    ...
                    <ul aria-expanded="false" class="collapse first-level">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Configuración</span></a>
                            <ul aria-expanded="false" class="collapse second-level">
                                ...
                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="provincias" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i>Departamentos</a></li>

                                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark" href="departamentos" aria-expanded="false"><i class="mdi mdi-clipboard-text"></i>Municipios</a></li>
